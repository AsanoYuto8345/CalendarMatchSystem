...
const LoginUI = ({
  ...
  return (
    <div className="max-w-md mx-auto mt-20 p-6 bg-white rounded shadow">
      ...
      <div className="mb-4">
        <label htmlFor="loginEmail" className="block mb-1 font-semibold">メールアドレス</label>
        <input
          type="email"
          id="loginEmail" // ★idを追加
          value={email}
      ...
      <div className="mb-4">
        <label htmlFor="loginPassword" className="block mb-1 font-semibold">パスワード</label>
        <input
          type="password"
          id="loginPassword" // ★idを追加
          value={password}
